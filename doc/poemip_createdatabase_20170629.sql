...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='设备信息表';

-- Dumping data for table poemip.tb_equipment: 1 rows
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='问题信息表';

-- Dumping data for table poemip.tb_issue: 7 rows
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='项目信息表';
...
INSERT INTO `tb_project` (`project_id`, `project_name`, `project_desc`, `create_date`, `user_id`, `user_name`, `last_update`) VALUES
	(22, '委内项目', '委内瑞拉项目', '2017-06-22 10:01:15', 1, '用户1名称', '2017-06-29 14:42:49');
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='项目和设备对照表';

-- Dumping data for table poemip.tb_project_equipment: 1 rows
...
CREATE TABLE IF NOT EXISTS `tb_project_equipment_supplier` (
  ...
  PRIMARY KEY (`id`),
  KEY `project_id_equipment_id` (`project_id`,`equipment_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='项目和供应商对照表';

-- Dumping data for table poemip.tb_project_equipment_supplier: 1 rows
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='供应商信息表';

-- Dumping data for table poemip.tb_supplier: 1 rows
...
INSERT INTO `tb_supplier` (`supplier_id`, `supplier_name`, `supplier_desc`, `create_date`, `user_id`, `user_name`, `last_update`) VALUES
	(7, '北京峰瑞达', '(请填写供应商“北京峰瑞达”的描述信息)', '2017-06-22 13:43:30', 1, '用户1名称', '2017-06-29 14:44:31');
